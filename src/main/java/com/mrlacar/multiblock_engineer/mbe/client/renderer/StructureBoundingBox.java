...
import static com.mrlacar.multiblock_engineer.mbe.common.item.StructureWandBehavior.getDir;
...
public class    StructureBoundingBox {
    public static void renderStructureSelect(PoseStack poseStack, Camera camera) {
        ...
        if (StructureWandBehavior.isItemStructureWand(held)) {
            BlockPos[] poses = StructureWandBehavior.getPos(held);
