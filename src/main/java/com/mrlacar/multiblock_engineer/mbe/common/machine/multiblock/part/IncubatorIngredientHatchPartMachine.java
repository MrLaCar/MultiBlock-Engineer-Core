...
public class IncubatorIngredientHatchPartMachine extends TieredIOPartMachine implements IDistinctPart, IMachineLife {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(IncubatorIngredientHatchPartMachine.class,
    ...
    public IncubatorIngredientHatchPartMachine(IMachineBlockEntity holder, Object...args) {
