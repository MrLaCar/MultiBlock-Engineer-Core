...
public class AdvancedMEPatternBufferProxyRecipeHandler<T> extends NotifiableRecipeHandlerTrait<T> {
    ...
    public AdvancedMEPatternBufferProxyRecipeHandler(MetaMachine machine, IO handlerIO, RecipeCapability<T> capability) {
        super(machine);
