package com.mrlacar.multiblock_engineer.mbe.integration.ae2.machine.trait;
...
public class AdvancedMEPatternBufferRecipeHandler extends MachineTrait {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            AdvancedMEPatternBufferPartMachine.class);
    ...
    public AdvancedMEPatternBufferRecipeHandler(AdvancedMEPatternBufferPartMachine ioBuffer) {
        super(ioBuffer);
    ...
    @Override
    public AdvancedMEPatternBufferPartMachine getMachine() {
        return (AdvancedMEPatternBufferPartMachine) super.getMachine();
    }
    ...
    public class ItemInputHandler extends NotifiableRecipeHandlerTrait<Ingredient> {
        ...
        public ItemInputHandler(AdvancedMEPatternBufferPartMachine machine) {
            super(machine);
        }

        public AdvancedMEPatternBufferPartMachine getMachine() {
            return (AdvancedMEPatternBufferPartMachine) this.machine;
        }
        ...
        public List<Object> getContents() {
            return Arrays.stream(getMachine().getInternalInventory())
                    .map(AdvancedMEPatternBufferPartMachine.InternalSlot::getItemInputs)
    ...
    public class FluidInputHandler extends NotifiableRecipeHandlerTrait<FluidIngredient> {
        ...
        public FluidInputHandler(AdvancedMEPatternBufferPartMachine machine) {
            super(machine);
        }
        ...
        public List<Object> getContents() {
            return Arrays.stream(getMachine().getInternalInventory())
                    .map(AdvancedMEPatternBufferPartMachine.InternalSlot::getFluidInputs)
                    .flatMap(Arrays::stream)
                    .collect(Collectors.toList());
        }
    ...
    public static Pair<Object2LongOpenHashMap<Item>, Object2LongOpenHashMap<Fluid>> mergeInternalSlot(
            AdvancedMEPatternBufferPartMachine.InternalSlot[] internalSlots) {
        ...
        for (AdvancedMEPatternBufferPartMachine.InternalSlot internalSlot : internalSlots) {
